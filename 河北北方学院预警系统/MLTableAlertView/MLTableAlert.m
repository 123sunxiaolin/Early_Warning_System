...
-(void)show
{
   ...
   // self.table.backgroundColor=[UIColor whiteColor];
	...
	tableGradient.colors = [NSArray arrayWithObjects:(id)[[UIColor colorWithRed:65.0/255.0 green:105.0/255.0 blue:225.0/255.0 alpha:0.8] CGColor], (id)[[UIColor colorWithRed:160.0/255.0 green:102.0/255.0 blue:211.0/255.0 alpha:1.0] CGColor], nil];
